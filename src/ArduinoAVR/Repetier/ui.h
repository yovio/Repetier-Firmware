...
#if FEATURE_CONTROLLER == CONTROLLER_ZONESTAR_ON_RAMPS

// Keypad
#if !defined(ADC_KEYPAD_PIN) || (ADC_KEYPAD_PIN < 0)
#error CONTROLLER_ZONESTAR_ON_RAMPS requres ADC_KEYPAD_PIN = 1 defined in Configuration.h
#endif

// This must be defined in the Configuration.h since used in ADC tables
//#define ADC_KEYPAD_PIN         12    // A12
...
#define UI_DISPLAY_ENABLE_PIN    41
#define UI_DISPLAY_RS_PIN        39
#define UI_DISPLAY_RW_PIN        -1
#define UI_DISPLAY_D4_PIN        32
#define UI_DISPLAY_D5_PIN        47
#define UI_DISPLAY_D6_PIN        45
#define UI_DISPLAY_D7_PIN        43
#endif
...
#endif // CONTROLLER_ZONESTAR_ON_RAMPS
